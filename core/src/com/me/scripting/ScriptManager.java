...
public class ScriptManager {
	 ...
	 */
	public ScriptManager(final String fileName) 
	{
	...
	public void runScriptFunction(String functionName, boolean obj){
		this.luaState.getGlobal(functionName);
		this.luaState.pushBoolean(obj);
		this.luaState.call(1, 0);
	}
	...
	public int getGlobalInt(String globalName){
		this.luaState.getGlobal(globalName);
		return this.luaState.toInteger(luaState.getTop());
	}
}
